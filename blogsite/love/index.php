<?php 
$metaTitle = 'Bodas - HTML Wedding Template';
$metakeywords = 'template,html,design,web,frontend,wedding,bodas,website,marriage,bride,groom,responsive,themeforest,envato';
$metaDescription = 'BODAS is a Responsive HTML Wedding Template with clean, elegant and modern design. Great for wedding invitation or engagement. Coming with wedding features such as Couple Timeline, Countdown, Photo gallery, featured people, Gift Registry, RSVP and others.';
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <!-- Global site tag (gtag.js) - Google Analytics 
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-108439848-2"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
    
      gtag('config', 'UA-108439848-2');
    </script>-->

    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="MarttinFisher - MachiMorales">
    ...
    <meta property="og:url" content="http://marttinfisher.com"/>
    <meta property="og:image" content="http://marttinfisher.com/themes/bodas/bodas_og-image.png"/>
    <meta property="og:site_name" content="MarttinFisher"/>
  ...
  <body>
    ...
    <section id="home" data-stellar-background-ratio="0.5">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <h3 class="title"><span></span>We are getting married!<span></span></h3>
                    <ul class="names">
                        <li>Marttin</li>
                        <li class="circle">&amp;</li>
                        <li>Julianne</li>
                    </ul>
                    <div class="date">Aug <span>23</span> 2018</div>
                    <div class="hour">5:00 <span>pm</span></div>
                    <div class="place">
                        <h3>Antigua Event Saloon</h3>
                        <p>453 West Street #56-WE3547 - Macondo, Florida.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="nav_menu">
                    <ul id="nav_list" class="nav navbar-nav navbar-right">
                        ...
                        <li class=""><a href="#featured-people">Featured People</a></li>
                        <li class=""><a href="#gift-registry">Gifts</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-xs-12 text-center">
                    <div class="profile">
                        <h2>Marttin <span>Fisher</span></h2>
                ...
                <div class="col-md-6 col-xs-12 text-center">
                    <div class="profile">
                        <h2>Julianne <span>Vélez</span></h2>
        ...
        <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 col-xs-12 text-center">
                        <h2><i class="fa fa-quote-left" aria-hidden="true"></i> Celebrate love with all your heart and share it with all your loved ones. Now you can start to do it with this HTML template... is perfect for you!. <i class="fa fa-quote-right" aria-hidden="true"></i></h2>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2 col-xs-12 text-center">
                    <div class="title-block">
                        <h1>Our <span><em>Story</em></span></h1>
            ...
            <ul class="timeline">
                <li>
                  ...
                  <div class="timeline-panel">
                    <div class="timeline-heading">
                      <h2 class="timeline-title">May <span>04</span> 2015</h2>
                    </div>
                ...
                <li class="timeline-inverted">
                  ...
                  <div class="timeline-panel">
                    <div class="timeline-heading">
                      <h2 class="timeline-title">Dec <span>28</span> 2015</h2>
                    </div>
                    <div class="timeline-body text-center">
                ...
                <li>
                  ...
                  <div class="timeline-panel">
                    <div class="timeline-heading">
                      <h2 class="timeline-title">Feb <span>16</span> 2016</h2>
                    </div>
                    <div class="timeline-body text-center">
                ...
                <li class="timeline-inverted">
                  ...
                  <div class="timeline-panel">
                    <div class="timeline-heading">
                      <h2 class="timeline-title">Oct <span>18</span> 2017</h2>
                    </div>
                    <div class="timeline-body text-center">
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2 col-xs-12 text-center">
                    <div class="final-frase">Now we are ready for the <span>next step...</span></div>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-md-offset-1 col-xs-12 text-center">
                    <div class="title-block">
                        <h1>Gifts <span><em>Registry</em></span></h1>
                        <div class="divider"></div>
    ...
    <!-- Color Switch -->
    <?php include('color-switch/color-switch.php');?>
  </body>
</html>